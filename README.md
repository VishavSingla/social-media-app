...
# Real-Time social-media-app : Next.js 13, React, Tailwind, Prisma, MongoDB, NextAuth, Pusher

This is a repository for social-media-app : Next.js 13, React, Tailwind, Prisma, MongoDB, NextAuth, Pusher.

Master the art of building a social-media-app  using the latest web development technologies. In this comprehensive tutorial, we'll walk you through the process of creating a fully-functional and visually stunning chat application that rivals the best in the industry.
...
```shell
git clone https://github.com/VishavSingla/social-media-app.git
```
